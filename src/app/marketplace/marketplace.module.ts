...
@NgModule({
  ...
  declarations: [MarketplacePageComponent, MarketplaceListComponent, ApplianceDetailPageComponent, ApplianceDetailControlComponent, AppPlaceHolderComponent, CloudLaunchConfigControlComponent],
  providers: [ApplicationService, DeploymentService, COMPILER_PROVIDERS]
})
